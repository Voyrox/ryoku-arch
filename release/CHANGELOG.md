...
### Changed
- **`ryotunes` 1.0.8-1 tracks neur0map/ryotunes v1.0.8.** Stopped Now Playing stuttering while the window is resized or scaled: the cover size read the column's assigned width and the body's assigned height,...
